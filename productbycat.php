    ...
    <div class="content">
        ...
        <div class="section group">
            ...
            <?php
                    ...
                    echo '<span style="font-size:20px; font-weight:bold;color: #ff7100; ">________________________________________________Danh mục này hiện chưa có sản phẩm !!!____________________________________________<span>';
            }
